...
ERROR_STR db 'Error with memory',0DH,0AH,'$'
...
FREE_MEM PROC
	...
	mov bx,0A000h ; предел доступного количества свободных параграфов, адрес начала видеобуфера
	mov ax,offset END_OF_PROGR 
	mov bl,16 
	div bl
	mov ah,0
	add ax,1
